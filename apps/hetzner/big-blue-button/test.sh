...
apt-get update
apt-get install -y expect tcl

# Run installer.
expect <<"EXPECT"
#!/usr/bin/expect -f
#
# This Expect script was generated by autoexpect on Wed Dec  1 13:02:46 2021
...
curl -sk https://localhost/b -Hhost:test.com | grep '<title>BigBlueButton</title>'
