...
#!/usr/bin/expect -f
#
# This Expect script was generated by autoexpect on Wed Dec  1 13:13:43 2021
...
set timeout -1
spawn /opt/hcloud/nextcloud_setup.sh
match_max 100000
...
curl -s localhost/login | grep 'a safe home for all your data'
